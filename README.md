...
-- Enable hardtime in "help" and "lspinfo" filetypes
disabled_filetypes = { 
   ["oil"] = { true },
   ["help"] = { false },
   ["lspinfo"] = {},
...
| `disabled_filetypes`     | table of strings/table pair  | [See Config](https://github.com/m4xshen/hardtime.nvim/blob/main/lua/hardtime/config.lua) | `hardtime.nvim` is disabled under these filetypes.                                                                                                                            |
